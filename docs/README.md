...
以下文档保留设计背景，旧命令、技术版本、采集范围与部署入口以当前开发指南和源码为准。

- [架构设计](01-architecture.md)
- [采集器设计](02-collectors.md)
- [早期开发指南](03-development.md)
- [测试设计](04-testing.md)
- [凭据遮盖设计](05-security.md)
- [仪表盘设计](06-dashboard.md)
- [采集器增强计划](07-collector-enhancement-plan.md)
- [Worker 迁移记录](archive/08-worker-migration.md)
- [Vite SPA 迁移记录](archive/09-vite-spa-migration.md)
